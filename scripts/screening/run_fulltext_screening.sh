...
: <<'USAGE'
usage: run_fulltext_screening.sh <pathogen> [data_dir] [model_name] [client_dir_name] [extra args...]

usage examples:
  5-row sample with OpenRouter + GLM 4.7 Flash
    scripts/screening/run_fulltext_screening.sh lassa data/agentslr z-ai/glm-4.7-flash glm_4_7_flash \
  ...
  Local vLLM example with a served model
    scripts/screening/run_fulltext_screening.sh lassa data/agentslr openai/gpt-oss-20b gpt_oss_20b \
