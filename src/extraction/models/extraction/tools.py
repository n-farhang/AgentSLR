# src/extraction/models/extraction/tools.py
"""
...
MODEL_TOOL_CALL = {
    ...
    "function": {
        ...
        "description": ("Extract characteristics for a single transmission model. "
                        "Call this function once per model. "
                        "Only transmission_route, assumptions, and interventions_type are multiple-select; "
                        "all other fields are single-select."
                        "Do not include regression-only analyses or other models where transmission is not modelled mechanistically. "),
        "strict": True,
        "parameters": {
            "type": "object",
